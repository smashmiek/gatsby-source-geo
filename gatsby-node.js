...
exports.sourceNodes = (
  ...
  const typeName =
    typeof configOptions.typeName === 'undefined'
      ? ''
      : configOptions.typeName.charAt(0).toUpperCase() +
        configOptions.typeName.slice(1)
